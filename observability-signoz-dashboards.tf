...
removed {
  from = restapi_object.dashboard["signoz-dashboards/cert-manager/cert-manager-dashboard.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/chaos-mesh/chaos-mesh.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/host-metrics.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/k8s-events-receiver.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/kubernetes-cluster-metrics.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/kubernetes-cronjobs.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/kubernetes-node-metrics-detailed.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/kubernetes-node-metrics-overall.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/kubernetes-pod-metrics-detailed.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/kubernetes-pod-metrics-overall.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-infra-metrics/kubernetes-pvc-metrics.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-system-monitoring/kubernetes-apiserver.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-system-monitoring/kubernetes-controller-manager.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-system-monitoring/kubernetes-coredns.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-system-monitoring/kubernetes-etcd.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-system-monitoring/kubernetes-kube-proxy.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-system-monitoring/kubernetes-kubelet.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-system-monitoring/kubernetes-scheduler.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/k8s-system-monitoring/kubernetes-system-overview.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/nginx/ingress-nginx-controller.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/nginx/nginx-ingress-request-handling-performance.json"]
...
removed {
  from = restapi_object.dashboard["signoz-dashboards/opentelemetry-collector/opentelemetry-collector-dashboard.json"]
